...
function ChatBubble({msg,myUid,isAdmin,T,onReact,onDelete,onReply,onScrollToMsg,allMsgs}){
  ...
  const ReactionBar=()=>(
    <div style={{display:"flex",gap:"4px",marginTop:"4px",flexWrap:"wrap",paddingLeft:"4px"}}>
      ...
      {!isSystem&&onReply&&<button onClick={()=>onReply(msg)} style={{background:"transparent",border:`1px solid ${T.border}44`,borderRadius:"12px",padding:"2px 7px",fontSize:"10px",cursor:"pointer",color:T.faint}}>↩</button>}
...
function LiveChat({role,T,mini=true,onExpand,onClearChat}){
  ...
  const visible=msgs.filter(m=>{
    ...
    if(prefs.everyMessage)return true;
    const sub=m.subtype==="matchDecisionT1"||m.subtype==="matchDecisionT2"?"matchDecision":m.subtype==="dayEnd"?"matchDecision":m.subtype;
    if(sub==="equalize")return prefs.leadChange!==false;
    if(sub==="birdie"||sub==="everyHole")return false;
