  ...
  return(
    <div style={{display:"flex",flexDirection:"column",gap:"10px"}}>
      ...
      <div style={{display:"flex",gap:"8px",alignItems:"center"}}>
        ...
        {/* Photo button — opens file picker supporting camera + gallery */}
        <label style={{background:T.isDark?"#0A2014":T.elevated,border:`1px solid ${T.border}`,borderRadius:"8px",padding:"10px 12px",cursor:"pointer",display:"flex",alignItems:"center",flexShrink:0,opacity:photoSending?0.5:1}}>
          {photoSending
            ?<div style={{width:"14px",height:"14px",border:`2px solid ${T.gold}`,borderTopColor:"transparent",borderRadius:"50%",animation:"spin 0.8s linear infinite"}}/>
        ...
        {/* Gallery button — no capture, opens photo library directly */}
        <label style={{background:T.isDark?"#0A2014":T.elevated,border:`1px solid ${T.border}`,borderRadius:"8px",padding:"10px 12px",cursor:"pointer",display:"flex",alignItems:"center",flexShrink:0,opacity:photoSending?0.5:1}}>
  ...
  const ShotSequenceBlock=({score,shots,setShots,putts,setPutts,playerIds,photos,pair,color,bgColor})=>{
    ...
    return(
      <div style={{marginTop:"10px",padding:"10px",background:bgColor+"44",borderRadius:"10px",border:`1px solid ${color}33`}}>
        ...
        {/* Putts counter - Fix 2: min 0 for chip-ins */}
        <div style={{display:"flex",alignItems:"center",gap:"8px",background:T.isDark?"#060E1A":T.elevated,borderRadius:"8px",padding:"6px 10px",border:`0.5px solid ${T.border}`}}>
          <span style={{fontSize:"9px",color:T.faint,flex:1}}>⛳ Davon Putts:</span>
          <button onClick={()=>setPutts(p=>Math.max(0,p-1))} style={{width:"26px",height:"26px",border:`1px solid ${T.border}`,background:T.elevated,borderRadius:"5px",fontSize:"14px",cursor:"pointer",color:T.muted}}>−</button>
          <span style={{fontSize:"16px",fontWeight:"900",color:"#2E7D32",width:"20px",textAlign:"center"}}>{putts}</span>
          <button onClick={()=>setPutts(p=>Math.min(score,p+1))} style={{width:"26px",height:"26px",border:`1px solid ${T.border}`,background:T.elevated,borderRadius:"5px",fontSize:"14px",cursor:"pointer",color:T.muted}}>+</button>
          <span style={{fontSize:"9px",fontWeight:"700",color:"#2E7D32",background:T.isDark?"#0A2014":"#E8F5E9",borderRadius:"4px",padding:"1px 6px"}}>{{0:"Chip-in 🏆",1:"1-Putt ⚡",2:"2-Putt ✓",3:"3-Putt ⚠️"}[putts]||putts+" Putts"}</span>
        </div>
              ...
              {(()=>{
                ...
                return(
                  <div style={{marginTop:"10px",padding:"10px",background:T.red+"22",borderRadius:"10px",border:`1px solid ${T.red}33`}}>
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:"8px",background:T.isDark?"#060E1A":T.elevated,borderRadius:"8px",padding:"6px 10px",border:`0.5px solid ${T.border}`}}>
                      <span style={{fontSize:"9px",color:T.faint,flex:1}}>⛳ Davon Putts:</span>
                      <button onClick={()=>setT2Putts(p=>Math.max(0,p-1))} style={{width:"26px",height:"26px",border:`1px solid ${T.border}`,background:T.elevated,borderRadius:"5px",fontSize:"14px",cursor:"pointer",color:T.muted}}>−</button>
                      <span style={{fontSize:"16px",fontWeight:"900",color:"#2E7D32",width:"20px",textAlign:"center"}}>{t2Putts}</span>
                      <button onClick={()=>setT2Putts(p=>Math.min(t2,p+1))} style={{width:"26px",height:"26px",border:`1px solid ${T.border}`,background:T.elevated,borderRadius:"5px",fontSize:"14px",cursor:"pointer",color:T.muted}}>+</button>
                      <span style={{fontSize:"9px",fontWeight:"700",color:"#2E7D32",background:T.isDark?"#0A2014":"#E8F5E9",borderRadius:"4px",padding:"1px 6px"}}>{{0:"Chip-in 🏆",1:"1-Putt ⚡",2:"2-Putt ✓",3:"3-Putt ⚠️"}[t2Putts]||t2Putts+" Putts"}</span>
                    </div>
                    <div style={{marginTop:"6px",fontSize:"9px",color:T.faint}}>
                      {t2PlayerIds.map((pid,i)=>{
