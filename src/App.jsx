          ...
          <div style={{display:"flex",flexDirection:"column",gap:"12px",marginBottom:"14px"}}>
            ...
            <div style={{background:T.blue+"11",borderRadius:"12px",border:`1px solid ${T.blue}33`,padding:"10px 12px"}}>
              ...
              <div style={{display:"flex",alignItems:"center",gap:"8px",marginBottom:"4px",flexWrap:"wrap"}}>
                ...
                <div style={{fontSize:"13px",fontWeight:"700",color:golfLabel(t1,hp).color}}>{golfLabel(t1,hp).label}</div>
                {/* Fix 5: Putt counter inline */}
                <div style={{display:"flex",alignItems:"center",gap:"5px",marginLeft:"auto",background:T.isDark?"#060E1A":T.elevated,borderRadius:"8px",padding:"5px 8px",border:`0.5px solid ${T.border}`}}>
                  <span style={{fontSize:"9px",color:T.faint}}>⛳</span>
                  ...
                  <span style={{fontSize:"8px",fontWeight:"700",color:"#2E7D32"}}>{{0:"Chip-in",1:"1-Putt⚡",2:"2-Putt✓",3:"3-Putt⚠️"}[t1Putts]||t1Putts+"P"}</span>
                </div>
              </div>
              {t1ShotsBlock}
            </div>
            ...
            <div style={{background:T.red+"11",borderRadius:"12px",border:`1px solid ${T.red}33`,padding:"10px 12px"}}>
              ...
              <div style={{display:"flex",alignItems:"center",gap:"8px",marginBottom:"4px",flexWrap:"wrap"}}>
                ...
                <div style={{fontSize:"13px",fontWeight:"700",color:golfLabel(t2,hp).color}}>{golfLabel(t2,hp).label}</div>
                {/* Fix 5: Putt counter inline for t2 */}
                <div style={{display:"flex",alignItems:"center",gap:"5px",marginLeft:"auto",background:T.isDark?"#060E1A":T.elevated,borderRadius:"8px",padding:"5px 8px",border:`0.5px solid ${T.border}`}}>
                  <span style={{fontSize:"9px",color:T.faint}}>⛳</span>
                  ...
                  <span style={{fontSize:"8px",fontWeight:"700",color:"#2E7D32"}}>{{0:"Chip-in",1:"1-Putt⚡",2:"2-Putt✓",3:"3-Putt⚠️"}[t2Putts]||t2Putts+"P"}</span>
                </div>
              </div>
