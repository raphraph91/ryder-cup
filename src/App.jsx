...
const DEFAULT_PREFS={matchDecision:true,birdie:true,leadChange:true,equalize:false,everyHole:false};
  ...
  const saveScore=async(dayId,matchId,hi,t1s,t2s,extraScores)=>{
    ...
    if(match&&course){
      ...
      if(rs.won&&!prevRs?.won){
        // Fix 5 (v3.04): richer chat messages with winner names + photos
        ...
        if(winner){
          ...
          text=`🏆 ${dot} ${winNames} ${pick}\n${matchName} · ${rLabel} · ${rs.label}`;
        }else{
          text=`🤝 ${matchName} · ${rLabel} endet All Square — Punkt wird geteilt`;
        }
